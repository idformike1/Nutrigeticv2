    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-sm">
      <Container className="flex min-h-[68px] items-center justify-between gap-4">
        <div className="flex items-center gap-10 lg:gap-14">
          <Link href="/" className="shrink-0 text-base font-semibold tracking-[-0.02em]">
            {siteConfig.name}
          </Link>
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "rounded-md px-3 py-3 text-sm font-medium text-muted transition-colors hover:bg-white hover:text-foreground",
